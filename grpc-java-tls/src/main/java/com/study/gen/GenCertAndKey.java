...
//		tbsGen.setSignature(new AlgorithmIdentifier(PKCSObjectIdentifiers.sha256WithRSAEncryption, DERNull.INSTANCE)); // 签名算法标识等于颁发者证书的密钥算法标识\
	...
	public static void main(String[] args) throws Exception {
		try {
			String caCert = "/home/shepard/workspace-agent/project-go/src/github.com/eviltomorrow/developer-kit/grpc-go-tls/certs/ca.crt";
			String caKey = "/home/shepard/workspace-agent/project-go/src/github.com/eviltomorrow/developer-kit/grpc-go-tls/certs/ca.key";
			...
			String serverCert = "/home/shepard/workspace-agent/project-go/src/github.com/eviltomorrow/developer-kit/grpc-go-tls/certs/server.crt";
			String serverPem = "/home/shepard/workspace-agent/project-go/src/github.com/eviltomorrow/developer-kit/grpc-go-tls/certs/server.pem";
